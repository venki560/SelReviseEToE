...
import resources.ExtentReportie;
import resources.base;

public class listener extends base implements ITestListener{

	ExtentTest ext;
	ExtentReports extent=ExtentReportie.getExtentReport();
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			extTest.get().addScreenCaptureFromPath(getScreenShot(testMethodName, driver), result.getMethod().getMethodName());
